...
if __name__ == '__main__':
    ...
    plot_rewards(rewards, 'PPO Inference Rewards', 'inference_rewards_residual_cl_5_4o.pdf')
    plot_threads_csv('threads.csv', 'inference_threads_plot_residual_cl_5_4o.png')
    plot_throughputs_csv('throughputs.csv', 'inference_throughputs_plot_residual_cl_5_4o.png')