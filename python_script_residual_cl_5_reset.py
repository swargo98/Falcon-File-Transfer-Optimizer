...
class NetworkOptimizationEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.current_step = 0
        self.simulator.sender_buffer_in_use = np.random.randint(0, self.simulator.sender_buffer_capacity)
        self.simulator.receiver_buffer_in_use = np.random.randint(0, self.simulator.receiver_buffer_capacity)
        ...
        self.state = SimulatorState(sender_buffer_remaining_capacity=sender_buffer_remaining_capacity,
...
if __name__ == '__main__':
    ...
    plot_rewards(rewards, 'PPO Inference Rewards', 'inference_rewards_residual_cl_5.pdf')
    plot_threads_csv('threads.csv', 'inference_threads_plot_residual_cl_5.png')
    plot_throughputs_csv('throughputs.csv', 'inference_throughputs_plot_residual_cl_5.png')