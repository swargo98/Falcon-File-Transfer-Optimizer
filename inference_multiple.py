...
if __name__ == '__main__':
    ...
    for i in range(inference_count):
        ...
        plot_rewards(rewards, 'PPO Inference Rewards', 'rewards/inference_rewards_residual_cl_5_claude_'+ str(i) +'.pdf')
        plot_threads_csv('threads.csv', optimals, 'threads/inference_threads_plot_residual_cl_5_claude_'+ str(i) +'.png')
        plot_throughputs_csv('throughputs.csv', optimals, 'throughputs/inference_throughputs_plot_residual_cl_5_claude_'+ str(i) +'.png') 