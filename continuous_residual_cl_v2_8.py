...
class NetworkSystemSimulator:
    ...
    def get_utility_value(self, threads):
        ...
        if self.track_states:
            with open('threads_residual_cl_v2_8.csv', 'a') as f:
                f.write(f"{read_thread}, {network_thread}, {write_thread}, {utility}\n")
            with open('throughputs_residual_cl_v2_8.csv', 'a') as f:
...
def train_ppo(env, agent, max_episodes=1000):
    ...
    for episode in tqdm(range(1, max_episodes + 1), desc="Episodes"):
        ...
        with open('episode_rewards_residual_cl_v2_8_2.csv', 'a') as f:
        ...
        if episode % 1000 == 0:
            save_model(agent, "models/residual_cl_v2_8_policy_"+ str(episode) +".pth", "models/residual_cl_v2_8_value_"+ str(episode) +".pth")
            print("Model saved successfully.")
...
def plot_threads_csv(threads_file='threads_dicrete_w_history_minibatch_mlp_deepseek_v2_84.csv', optimals = None, output_file='threads_plot.png'):
    optimal_read, optimal_network, optimal_write, _ = optimals
    data = []

    # Read data from threads_dicrete_w_history_minibatch_mlp_deepseek_v2_84.csv
    ...
    with open('average_threads_dicrete_w_history_minibatch_mlp_deepseek_v2_84.csv', 'a') as f:
...
def plot_throughputs_csv(throughputs_file='throughputs_dicrete_w_history_minibatch_mlp_deepseek_v2_84.csv', optimals = None, output_file='throughputs_plot.png'):
    optimal_throughput = optimals[-1]
    data = []

    # Read data from throughputs_dicrete_w_history_minibatch_mlp_deepseek_v2_84.csv
    ...
    with open('average_throughput_dicrete_w_history_minibatch_mlp_deepseek_v2_84.csv', 'a') as f:
...
if __name__ == '__main__':
    if os.path.exists('threads_residual_cl_v2_8.csv'):
        os.remove('threads_residual_cl_v2_8.csv')
    if os.path.exists('throughputs_residual_cl_v2_8.csv'):
        os.remove('throughputs_residual_cl_v2_8.csv')
    ...
    plot_rewards(rewards, 'PPO Training Rewards', 'training_rewards_training_residual_cl_v2_8.pdf')
    ...
    for i in range(inference_count):
        ...
        policy_model = 'training_residual_cl_v2_8_policy_400000.pth'
        value_model = 'training_residual_cl_v2_8_value_400000.pth'
        ...
        plot_rewards(rewards, 'PPO Inference Rewards', 'rewards/inference_rewards_training_residual_cl_v2_8_'+ str(i) +'.pdf')
        plot_threads_csv('threads_residual_cl_v2_8.csv', optimals, 'threads/inference_threads_plot_training_residual_cl_v2_8_'+ str(i) +'.png')
        plot_throughputs_csv('throughputs_residual_cl_v2_8.csv', optimals, 'throughputs/inference_throughputs_plot_training_residual_cl_v2_8_'+ str(i) +'.png') 