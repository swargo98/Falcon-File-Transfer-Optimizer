...
if __name__ == '__main__':
    ...
    rewards = train_ppo(env, agent, max_episodes=60000)
    ...
    for i in range(inference_count):
        ...
        policy_model = 'training_gradient_thread_sp_stability_policy_60000.pth'
        value_model = 'training_gradient_thread_sp_stability_value_60000.pth'
